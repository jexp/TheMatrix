...
- (void)insertNewObject {
    ...
    [newManagedObject setValue:@"localhost" forKey:@"host"];
    [newManagedObject setValue:[NSNumber numberWithInt:7474] forKey:@"port"];
...
- (NSFetchedResultsController *)fetchedResultsController {
    ...
    */
    ...
    NSSortDescriptor *sortDescriptor = [[NSSortDescriptor alloc] initWithKey:@"host" ascending:NO];
